...
CPromptJSON=${BaseDir}/Prompt/Cert_190456-203002_8TeV_PromptReco_Collisions12_JSON_v2.txt
DPromptJSON=${BaseDir}/Prompt/Cert_190456-208686_8TeV_PromptReco_Collisions12_JSON.txt
...
echo "C prompt: $CPromptJSON"
echo "D prompt: $DPromptJSON"
...
filterJSON.py --min 198934 --max 203746 ${CPromptJSON} --output myCpromptJSON.txt
filterJSON.py --min 203768 --max 999999 ${DPromptJSON} --output myDpromptJSON.txt
mergeJSON.py myCpromptJSON.txt myDpromptJSON.txt --output=fullPromptJSON.txt
mergeJSON.py fullReRecoJSON.txt fullPromptJSON.txt --output=goldenAnalysisJSON.txt
