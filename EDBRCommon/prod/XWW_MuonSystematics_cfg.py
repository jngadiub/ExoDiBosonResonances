...
process.muonSmearer = cms.EDProducer("PATMuonSmearProducer",
...
###
#                                     momentumScale = cms.double(0.002), #0.2 percent or 0.6 percent for resolution
#                                     extraMomentumScale = cms.double(0.05), #5 percent above 200 GeV
#                                     isScale = cms.bool(True),
#                                     isPositive = cms.bool(True)
#                                     isPositive = cms.bool(False)
###
#                                     momentumScale = cms.double(0.006), #0.2 percent or 0.6 percent for resolution
#                                     extraMomentumScale = cms.double(0.0), #5 percent above 200 GeV
...
process.selectedPatMuons.src = cms.InputTag("muonSmearer")
               
# 3) Add the muon smearer at the beginning of the paths
process.preselElePath.replace(process.selectedPatMuons, process.muonSmearer+process.selectedPatMuons)
process.preselEleMergedPath.replace(process.selectedPatMuons, process.muonSmearer+process.selectedPatMuons)
process.cmgEDBRWWEle.replace(process.selectedPatMuons, process.muonSmearer+process.selectedPatMuons)


process.preselMuPath.replace(process.selectedPatMuons, process.muonSmearer+process.selectedPatMuons)
process.preselMuMergedPath.replace(process.selectedPatMuons, process.muonSmearer+process.selectedPatMuons)
process.cmgEDBRWWMu.replace(process.selectedPatMuons, process.muonSmearer+process.selectedPatMuons)
