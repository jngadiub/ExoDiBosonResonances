...
if [ $1 == "DATA" ]
    ...
    OUTPATH="/store/cmst3/user/santanas/ExoDiBosonResonances/CMGtuple/production0312/Run12/CA8/"
...
if [ $1 == "MC" ]
    ...
    OUTPATH="/store/cmst3/user/santanas/ExoDiBosonResonances/CMGtuple/production0312/Summer12/CA8/"
