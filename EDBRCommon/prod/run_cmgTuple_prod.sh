...
OUTPATHBASE="/store/group/phys_exotica/leptonsPlusJets/ExoDiBosonResonances/CMGtuple/tomei_edbr_vv_20130313/"

OUTPATHDATA=${OUTPATHBASE}/Run2012/AK7/
OUTPATHMC=${OUTPATHBASE}/Summer12/AK7/
OUTLOGPATH="$(pwd)/logs"
