...
EXOZZ1JELE="xzz_ee1JLP=xzz_ee1JLP.${MASS}.txt xzz_ee1JHP=xzz_ee1JHP.${MASS}.txt"
EXOZZ1JMU="xzz_mm1JLP=xzz_mm1JLP.${MASS}.txt xzz_mm1JHP=xzz_mm1JHP.${MASS}.txt"
...
if (( $MASS < 800)); then 
    ...
    combineCards.py -S $EXOZZ1J   > comb_xzz_2l1J.txt
