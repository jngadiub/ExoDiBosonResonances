...
parser.add_option('-c','--category', action="store",type="int",dest="category",default="0")#0 ele LP ; 1: ele HP; 2: mu LP;  3: mu HP
...
class doFit_wj_and_wlvj:
    def __init__(self, in_channel,in_signal_sample, in_mlvj_signal_region_min=500, in_mlvj_signal_region_max=700, in_mj_min=30, in_mj_max=140, in_mlvj_min=400., in_mlvj_max=1400., fit_model="ErfExp_v1", fit_model_alter="ErfPow_v1", input_workspace=None):
        ...
        #self.file_data=("treeEDBR_pseudodata_xww.root");#keep blind!!!!
        #self.file_pseudodata=("treeEDBR_pseudodata_xww.root");#fake data
        ...
        self.rlt_DIR="cards_%s_%s/"%(options.additioninformation, self.channel)

        self.file_rlt_txt           = self.rlt_DIR+"other_wwlvj_%s_%s.txt"%(self.signal_sample,self.channel)
        self.file_rlt_root          = self.rlt_DIR+"wwlvj_%s_%s_%02d_%02d_workspace.root"%(self.signal_sample,self.channel,options.cprime,options.BRnew)
        self.file_datacard_unbin    = self.rlt_DIR+"wwlvj_%s_%s_%02d_%02d_unbin.txt"%(self.signal_sample,self.channel,options.cprime,options.BRnew)
        self.file_datacard_counting = self.rlt_DIR+"wwlvj_%s_%s_%02d_%02d_counting.txt"%(self.signal_sample,self.channel,options.cprime,options.BRnew)
...
'''
    ...
    def make_Pdf(self, label, in_model_name, mass_spectrum="_mj", ConstraintsList=[]):
        ...
        if in_model_name == "CB_v1":
            ...
            if label_tstring.Contains("H600"): 
                ...
                if label_tstring.Contains("600") and (not  label_tstring.Contains("1600") ): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel, 600, 500, 700);
                elif label_tstring.Contains("700"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel, 700, 600, 800);
                elif label_tstring.Contains("800"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel, 800, 600, 800);
                elif label_tstring.Contains("900"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel, 900, 600, 800);
                elif label_tstring.Contains("1000"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel,1000, 900,1100);
                elif label_tstring.Contains("1100"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel,1100,1000,1200);
                elif label_tstring.Contains("1200"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel,1200,1100,1300);
                elif label_tstring.Contains("1300"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel,1300,1200,1400);
                elif label_tstring.Contains("1400"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel,1400,1300,1500);
                elif label_tstring.Contains("1500"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel,1500,1400,1600);
                elif label_tstring.Contains("1600"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel,1600,1500,1700);
                elif label_tstring.Contains("1700"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel,1700,1500,1800);
                elif label_tstring.Contains("1800"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel,1800,1500,1900);
                elif label_tstring.Contains("1900"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel,1900,1500,2000);
                elif label_tstring.Contains("2000"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel,2000,1800,2200);
                elif label_tstring.Contains("2100"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel,2100,1800,2300);
                elif label_tstring.Contains("2200"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel,2200,1800,2400);
                elif label_tstring.Contains("2300"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel,2300,1800,2500);
                elif label_tstring.Contains("2400"): rrv_mean_CB=RooRealVar("rrv_mean_CB"+label+"_"+self.channel,"rrv_mean_CB"+label+"_"+self.channel,2400,1800,2600);
                else :
        ...
        if in_model_name == "ExpN":
            rrv_c_ExpN = RooRealVar("rrv_c_ExpN"+label+"_"+self.channel,"rrv_c_ExpN"+label+"_"+self.channel,-7e-3,-1e-2,-4e-3);
            rrv_n_ExpN = RooRealVar("rrv_n_ExpN"+label+"_"+self.channel,"rrv_n_ExpN"+label+"_"+self.channel, 1.0,0.5,1.5);
    ...
    def get_WJets_mlvj_correction_sb_lo_to_signal_region(self,label, mlvj_model):#exo-vv method: extract M_lvj shape of signal_region from sb_lo
        ...
        if mlvj_model=="Exp":
            ...
            rrv_delta_c = RooRealVar("rrv_delta_c_Exp%s_%s"%(label,self.channel),"rrv_delta_c_Exp%s_%s"%(label,self.channel),
                    ...
                    self.workspace4fit_.var("rrv_c_Exp%s_signal_region_%s"%(label,self.channel)).getVal()-rrv_c_sb.getVal()+4*rrv_c_sb.getError() )
                    #0., -100*rrv_c_sb.getError(),100*rrv_c_sb.getError()); 
        ...
        if label=="_WJets0":
            ...
            self.draw_canvas_with_pull( mplot_sb_lo, mplot_pull_sideband,parameters_list,"plots_%s_%s_%s/other/"%(options.additioninformation, self.channel,self.PS_model), "m_lvj%s_sb_lo_sim"%(label),"",1,0)
            ...
            self.draw_canvas_with_pull( mplot_signal_region, mplot_pull_signal_region,parameters_list,"plots_%s_%s_%s/other/"%(options.additioninformation, self.channel,self.PS_model), "m_lvj%s_signal_region_sim"%(label),"",1,0);
        ...
        #if self.signal_sample=="ggH600" or self.signal_sample=="ggH700": mplot.GetYaxis().SetRangeUser(0,0.25);
        #else: mplot.GetYaxis().SetRangeUser(0,0.28);
        mplot.GetYaxis().SetRangeUser(1e-3,0.28);
        #mplot.GetYaxis().SetRangeUser(1e-5,1);
 
        self.draw_canvas(mplot,"plots_%s_%s_%s/other/"%(options.additioninformation, self.channel,self.PS_model),"correction_pdf%s_%s_%s_M_lvj_signal_region_to_sideband"%(label,self.PS_model,self.MODEL_4_mlvj),0,1);
    ...
    def fit_mj_single_MC(self,in_file_name, label, in_model_name, additioninformation=""):
        ...
        self.draw_canvas_with_pull( mplot, mplot_pull,parameters_list,"plots_%s_%s_%s/m_j_fitting%s_wtaggercut%s_nPV%sto%s/"%(options.additioninformation, self.channel,self.PS_model, additioninformation, self.wtagger_label, self.nPV_min, self.nPV_max), label+in_file_name, in_model_name)
        rfresult.Print(); 
        #rfresult.covarianceMatrix().Print(); #raw_input("ENTER"); 
    ...
    def fit_mj_singlebackground_MC_TTbar_controlsample(self,in_file_name, label, in_model_name):
        ...
        parameters_list=model.getParameters(rdataset_mj);
        mplot.GetYaxis().SetRangeUser(1e-2,mplot.GetMaximum()*1.1);
        self.draw_canvas_with_pull( mplot, mplot_pull,parameters_list,"plots_%s_%s_%s/m_j_fitting_TTbar_controlsample_wtaggercut%s_nPV%sto%s/"%(options.additioninformation, self.channel,self.PS_model, self.wtagger_label, self.nPV_min, self.nPV_max), label+in_file_name, in_model_name)
        rfresult.Print();
    ...
    def fit_mj_TTbar_controlsample(self,in_file_name):
        ...
        number_STop =RooRealVar("rrv_number_STop" ,"rrv_number_STop",rdataset_STop_mj.sumEntries());
        number_VV   =RooRealVar("rrv_number_VV"   ,"rrv_number_VV",rdataset_VV_mj.sumEntries());
        number_WJets=RooRealVar("rrv_number_WJets","rrv_number_WJets",rdataset_WJets_mj.sumEntries());
        model_STop =RooExtendPdf("model_STop","model_STop",model_pdf_STop,number_STop)
        model_VV   =RooExtendPdf("model_VV","model_VV",model_pdf_VV,number_VV)
        model_WJets=RooExtendPdf("model_WJets","model_WJets",model_pdf_WJets,number_WJets)
        ...
        #self.with_tau2tau1
        model_ttbar_data = self.make_Model("_ttbar_data","2Gaus_ttbar_"+self.with_tau2tau1);
        model_bkg_data = self.make_Model("_bkg_data","ErfExp_ttbar_"+self.with_tau2tau1);
        model_ttbar_TotalMC = self.make_Model("_ttbar_TotalMC","2Gaus_ttbar_"+self.with_tau2tau1);
        model_bkg_TotalMC = self.make_Model("_bkg_TotalMC","ErfExp_ttbar_"+self.with_tau2tau1);
        model_data=RooAddPdf("model_data","model_data", RooArgList(model_ttbar_data, model_bkg_data));
        model_TotalMC=RooAddPdf("model_TotalMC","model_TotalMC", RooArgList(model_ttbar_TotalMC, model_bkg_TotalMC));

        if self.with_tau2tau1=="with_tau2tau1" and self.channel=="mu":
            self.workspace4fit_.var("rrv_number_ttbar_data"+"_"+self.channel+"_mj").setMax(1261.87);
            self.workspace4fit_.var("rrv_number_ttbar_TotalMC"+"_"+self.channel+"_mj").setMax(1271.02);
        elif self.with_tau2tau1=="with_tau2tau1" and self.channel=="el":
            self.workspace4fit_.var("rrv_number_ttbar_data"+"_"+self.channel+"_mj").setMax(993.39 );
            self.workspace4fit_.var("rrv_number_ttbar_TotalMC"+"_"+self.channel+"_mj").setMax(1047.53);


        model_data.fitTo(rdataset_data_mj,RooFit.Save(1), RooFit.Extended(kTRUE) , RooFit.Range("controlsample_fitting_range") );
        rfresult_data = model_data.fitTo(rdataset_data_mj,RooFit.Save(1), RooFit.Extended(kTRUE) , RooFit.Range("controlsample_fitting_range") );
        ...
        rfresult_TotalMC =model_TotalMC.fitTo(rdataset_TotalMC_mj, RooFit.SumW2Error(kTRUE),RooFit.Save(1), RooFit.Extended(kTRUE), RooFit.Range("controlsample_fitting_range") );
        ...
        model_pdf_WJets.plotOn(mplot,RooFit.Normalization(scale_number_WJets),RooFit.Name("WJets"),RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["ZJets"]), RooFit.LineColor(self.color_palet["ZJets"]), RooFit.VLines())
        ...
        if self.wtagger_cut<10:
            ...
            model_TotalMC.plotOn( mplot,RooFit.Normalization(scale_number_TotalMC) ,RooFit.Name("MC fit comp") ,RooFit.NormRange("controlsample_fitting_range") , RooFit.Components("model_pdf_bkg_TotalMC_%s_mj"%(self.channel)),  RooFit.LineStyle(kDashed), RooFit.LineColor(kRed) );
            model_data.plotOn( mplot,RooFit.Name("data fit"), RooFit.NormRange("controlsample_fitting_range") );
            model_data.plotOn( mplot,RooFit.Name("data fit comp"), RooFit.NormRange("controlsample_fitting_range"), RooFit.Components("model_pdf_bkg_data_%s_mj"%(self.channel)), RooFit.LineColor(kRed) );
            model_data.plotOn( mplot,RooFit.Name("data fit invisi"), RooFit.NormRange("controlsample_fitting_range") );
        ...
        rrv_mean_gaus_data=parameters_list.find("rrv_mean1_gaus_ttbar_data"+"_"+self.channel);
        rrv_sigma_gaus_data=parameters_list.find("rrv_sigma1_gaus_ttbar_data"+"_"+self.channel);
        rrv_mean_gaus_TotalMC=parameters_list.find("rrv_mean1_gaus_ttbar_TotalMC"+"_"+self.channel);
        rrv_sigma_gaus_TotalMC=parameters_list.find("rrv_sigma1_gaus_ttbar_TotalMC"+"_"+self.channel);
        tl_MC_mean   =TLatex(0.65 ,0.42, ("Mean_{MC  } = %3.1f #pm %2.1f")%(rrv_mean_gaus_TotalMC.getVal(), rrv_mean_gaus_TotalMC.getError()) );
        tl_MC_sigma  =TLatex(0.65 ,0.37, ("Sigma_{MC  }= %2.1f #pm %2.1f")%(rrv_sigma_gaus_TotalMC.getVal(), rrv_sigma_gaus_TotalMC.getError()) );
        #tl_data_mean =TLatex(0.65 ,0.32, ("Mean_{data} = %3.1f #pm %2.1f")%(rrv_mean_gaus_data.getVal(), rrv_mean_gaus_data.getError()) );
        tl_data_mean =TLatex(0.65 ,0.32, ("Mean_{data} = %3.1f #pm %2.1f")%(rrv_mean_gaus_data.getVal(), 0.6 ) );
        tl_data_sigma=TLatex(0.65 ,0.27, ("Sigma_{data}= %2.1f #pm %2.1f")%(rrv_sigma_gaus_data.getVal(), rrv_sigma_gaus_data.getError()) );
        ...
        mplot.GetYaxis().SetRangeUser(1e-2,mplot.GetMaximum()*1.1);
        self.draw_canvas_with_pull( mplot, mplot_pull,parameters_list,"plots_%s_%s_%s/m_j_fitting_TTbar_controlsample_wtaggercut%s_nPV%sto%s/"%(options.additioninformation, self.channel,self.PS_model, self.wtagger_label, self.nPV_min, self.nPV_max), in_file_name, "ErfExp2Gaus"+"Total"+self.with_tau2tau1)
        self.draw_canvas(mplot,"plots_%s_%s_%s/m_j_fitting_TTbar_controlsample_wtaggercut%s_nPV%sto%s/"%(options.additioninformation, self.channel,self.PS_model, self.wtagger_label, self.nPV_min, self.nPV_max),"control_%s_%s_%s"%(self.wtagger_label,self.channel,self.with_tau2tau1));
        
        #calculate the mva eff
        rrv_number_ttbar_data=parameters_list.find("rrv_number_ttbar_data"+"_"+self.channel+"_mj");
        rrv_number_ttbar_TotalMC=parameters_list.find("rrv_number_ttbar_TotalMC"+"_"+self.channel+"_mj");
        rrv_number_ttbar_data.Print();
        rrv_number_ttbar_TotalMC.Print();
        ...
        rrv_number_TTbar_in_mj_signal_region_from_fitting_data=RooRealVar("rrv_number_TTbar_in_mj_signal_region_from_fitting_data_%s"%(self.channel),"rrv_number_TTbar_in_mj_signal_region_from_fitting_data_%s"%(self.channel),rrv_number_ttbar_data.getVal()*signalInt_val_data);
        #error
        rrv_number_TTbar_in_mj_signal_region_from_fitting_data.setError( Calc_error_extendPdf(rdataset_data_mj, model_ttbar_data, rfresult_data,"signal_region") );
        rrv_number_TTbar_in_mj_signal_region_from_fitting_data.Print();
        #getattr(self.workspace4fit_,"import")(rrv_number_WJets_in_mj_signal_region_from_fitting);
        fullInt_TotalMC   = model_ttbar_TotalMC.createIntegral(RooArgSet(rrv_mass_j),RooArgSet(rrv_mass_j) );
        signalInt_TotalMC = model_ttbar_TotalMC.createIntegral(RooArgSet(rrv_mass_j),RooArgSet(rrv_mass_j),("signal_region"));
        fullInt_val_TotalMC=fullInt_TotalMC.getVal()
        signalInt_val_TotalMC=signalInt_TotalMC.getVal()/fullInt_val_TotalMC
        rrv_number_TTbar_in_mj_signal_region_from_fitting_TotalMC=RooRealVar("rrv_number_TTbar_in_mj_signal_region_from_fitting_TotalMC_%s"%(self.channel),"rrv_number_TTbar_in_mj_signal_region_from_fitting_TotalMC_%s"%(self.channel),rrv_number_ttbar_TotalMC.getVal()*signalInt_val_TotalMC);
        #error
        rrv_number_TTbar_in_mj_signal_region_from_fitting_TotalMC.setError( Calc_error_extendPdf(rdataset_TotalMC_mj, model_ttbar_TotalMC, rfresult_TotalMC,"signal_region") );
        rrv_number_TTbar_in_mj_signal_region_from_fitting_TotalMC.Print();
        #getattr(self.workspace4fit_,"import")(rrv_number_WJets_in_mj_signal_region_from_fitting);
        print "number in signal region"
        rrv_number_TTbar_in_mj_signal_region_from_fitting_data.Print();
        rrv_number_TTbar_in_mj_signal_region_from_fitting_TotalMC.Print();
    ...
    def ScaleFactor_forPureWJet_TTbar_controlsample(self,in_file_name, fit_or_not=1):#stateoftau2tau1cut="", or "failtau2tau1cut_"
        ...
        combData_p_f_data.plotOn(xframe_data,RooFit.Name("data invisi"), RooFit.Cut("category_p_f_%s==category_p_f_%s::pass"%(self.channel,self.channel)));
        combData_p_f_data.plotOn(xframe_data_fail,RooFit.Name("data invisi"), RooFit.Cut("category_p_f_%s==category_p_f_%s::fail"%(self.channel,self.channel)));
        
        model_TTbar_STop_VV_WJets.plotOn(xframe_data,RooFit.Normalization(scale_number_TTbar_STop_VV_WJets),RooFit.Name("TTbar"),RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["TTbar"]), RooFit.LineColor(self.color_palet["TTbar"]), RooFit.VLines())
        model_TTbar_STop_VV_WJets.plotOn(xframe_data,RooFit.Normalization(scale_number_TTbar_STop_VV_WJets),RooFit.Name("STop"),RooFit.Components("%s,%s,%s"%(model_histpdf_STop.GetName(), model_histpdf_VV.GetName(), model_histpdf_WJets.GetName()) ), RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["STop"]), RooFit.LineColor(self.color_palet["STop"]), RooFit.VLines())
        model_TTbar_STop_VV_WJets.plotOn(xframe_data,RooFit.Normalization(scale_number_TTbar_STop_VV_WJets),RooFit.Name("VV"),RooFit.Components("%s,%s"%(model_histpdf_VV.GetName(), model_histpdf_WJets.GetName()) ), RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["VV"]), RooFit.LineColor(self.color_palet["VV"]), RooFit.VLines())
        model_TTbar_STop_VV_WJets.plotOn(xframe_data,RooFit.Normalization(scale_number_TTbar_STop_VV_WJets),RooFit.Name("ZJets"),RooFit.Components("%s"%(model_histpdf_WJets.GetName()) ), RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["ZJets"]), RooFit.LineColor(self.color_palet["ZJets"]), RooFit.VLines())

        model_TTbar_STop_VV_WJets_fail.plotOn(xframe_data_fail,RooFit.Normalization(scale_number_TTbar_STop_VV_WJets_fail),RooFit.Name("TTbar"), RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["TTbar"]), RooFit.LineColor(self.color_palet["TTbar"]), RooFit.VLines())
        model_TTbar_STop_VV_WJets_fail.plotOn(xframe_data_fail,RooFit.Normalization(scale_number_TTbar_STop_VV_WJets_fail),RooFit.Name("STop"),RooFit.Components("%s,%s,%s"%(model_histpdf_STop_fail.GetName(), model_histpdf_VV_fail.GetName(), model_histpdf_WJets_fail.GetName()) ), RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["STop"]), RooFit.LineColor(self.color_palet["STop"]), RooFit.VLines())
        model_TTbar_STop_VV_WJets_fail.plotOn(xframe_data_fail,RooFit.Normalization(scale_number_TTbar_STop_VV_WJets_fail),RooFit.Name("VV"),RooFit.Components("%s,%s"%(model_histpdf_VV_fail.GetName(), model_histpdf_WJets_fail.GetName()) ), RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["VV"]), RooFit.LineColor(self.color_palet["VV"]), RooFit.VLines())
        model_TTbar_STop_VV_WJets_fail.plotOn(xframe_data_fail,RooFit.Normalization(scale_number_TTbar_STop_VV_WJets_fail),RooFit.Name("ZJets"),RooFit.Components("%s"%( model_histpdf_WJets_fail.GetName()) ), RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["ZJets"]), RooFit.LineColor(self.color_palet["ZJets"]), RooFit.VLines())


        combData_p_f_data.plotOn(xframe_data,RooFit.Name("data"), RooFit.Cut("category_p_f_%s==category_p_f_%s::pass"%(self.channel,self.channel)));
        combData_p_f_data.plotOn(xframe_data_fail,RooFit.Name("data"), RooFit.Cut("category_p_f_%s==category_p_f_%s::fail"%(self.channel,self.channel)));
        ...
        leg_data=self.legend4Plot(xframe_data,0)
        xframe_data.addObject(leg_data)
        leg_data_fail=self.legend4Plot(xframe_data_fail,0)
        ...
        self.draw_canvas(xframe_data,"plots_%s_%s_%s/m_j_fitting_TTbar_controlsample_wtaggercut%s_nPV%sto%s/"%(options.additioninformation, self.channel,self.PS_model, self.wtagger_label, self.nPV_min, self.nPV_max),"control_%s_%s"%(self.wtagger_label,self.channel));
        self.draw_canvas(xframe_data_fail,"plots_%s_%s_%s/m_j_fitting_TTbar_controlsample_wtaggercut%s_nPV%sto%s/"%(options.additioninformation, self.channel,self.PS_model, self.wtagger_label, self.nPV_min, self.nPV_max),"control_%s_%s_fail"%(self.wtagger_label,self.channel));
    ...
    def draw_ScaleFactor_forPureWJet_TTbar_controlsample(self,in_file_name, fit_or_not=1):#stateoftau2tau1cut="", or "failtau2tau1cut_"
        ...
        model_TTbar_STop_VV_WJets.plotOn(xframe_data,RooFit.Normalization(scale_number_TTbar_STop_VV_WJets),RooFit.Name("STop"),RooFit.Components("%s,%s,%s"%(model_histpdf_STop.GetName(), model_histpdf_VV.GetName(), model_histpdf_WJets.GetName()) ), RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["STop"]), RooFit.LineColor(self.color_palet["STop"]), RooFit.VLines())
        model_TTbar_STop_VV_WJets.plotOn(xframe_data,RooFit.Normalization(scale_number_TTbar_STop_VV_WJets),RooFit.Name("VV"),RooFit.Components("%s,%s"%(model_histpdf_VV.GetName(), model_histpdf_WJets.GetName()) ), RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["VV"]), RooFit.LineColor(self.color_palet["VV"]), RooFit.VLines())
        model_TTbar_STop_VV_WJets.plotOn(xframe_data,RooFit.Normalization(scale_number_TTbar_STop_VV_WJets),RooFit.Name("WJets"),RooFit.Components("%s"%(model_histpdf_WJets.GetName()) ), RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["ZJets"]), RooFit.LineColor(self.color_palet["ZJets"]), RooFit.VLines())

        model_TTbar_STop_VV_WJets_fail.plotOn(xframe_data_fail,RooFit.Normalization(scale_number_TTbar_STop_VV_WJets_fail),RooFit.Name("TTbar"), RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["TTbar"]), RooFit.LineColor(self.color_palet["TTbar"]), RooFit.VLines())
        model_TTbar_STop_VV_WJets_fail.plotOn(xframe_data_fail,RooFit.Normalization(scale_number_TTbar_STop_VV_WJets_fail),RooFit.Name("STop"),RooFit.Components("%s,%s,%s"%(model_histpdf_STop_fail.GetName(), model_histpdf_VV_fail.GetName(), model_histpdf_WJets_fail.GetName()) ), RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["STop"]), RooFit.LineColor(self.color_palet["STop"]), RooFit.VLines())
        model_TTbar_STop_VV_WJets_fail.plotOn(xframe_data_fail,RooFit.Normalization(scale_number_TTbar_STop_VV_WJets_fail),RooFit.Name("VV"),RooFit.Components("%s,%s"%(model_histpdf_VV_fail.GetName(), model_histpdf_WJets_fail.GetName()) ), RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["VV"]), RooFit.LineColor(self.color_palet["VV"]), RooFit.VLines())
        model_TTbar_STop_VV_WJets_fail.plotOn(xframe_data_fail,RooFit.Normalization(scale_number_TTbar_STop_VV_WJets_fail),RooFit.Name("WJets"),RooFit.Components("%s"%( model_histpdf_WJets_fail.GetName()) ), RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["ZJets"]), RooFit.LineColor(self.color_palet["ZJets"]), RooFit.VLines())
        ...
        if self.wtagger_cut<10:
            combData_p_f_TotalMC.plotOn(xframe_data,RooFit.Name("TotalMC invisi"), RooFit.Cut("category_p_f_%s==category_p_f_%s::pass"%(self.channel,self.channel)), RooFit.MarkerColor(kWhite), RooFit.LineColor(kWhite), RooFit.Invisible() );
            simPdf_TotalMC.plotOn(xframe_data,RooFit.Name("MC fit"),RooFit.Slice(category_p_f,"pass"),RooFit.ProjWData(RooArgSet(category_p_f),combData_p_f_TotalMC),RooFit.NormRange("controlsample_fitting_range"), RooFit.LineStyle(kDashed))
            ...
            combData_p_f_TotalMC.plotOn(xframe_data_fail,RooFit.Name("TotalMC invisi"), RooFit.Cut("category_p_f_%s==category_p_f_%s::fail"%(self.channel,self.channel)), RooFit.MarkerColor(kWhite), RooFit.LineColor(kWhite), RooFit.Invisible() );
            simPdf_TotalMC.plotOn(xframe_data_fail,RooFit.Name("MC fit"),RooFit.Slice(category_p_f,"fail"),RooFit.ProjWData(RooArgSet(category_p_f),combData_p_f_TotalMC),RooFit.NormRange("controlsample_fitting_range"), RooFit.LineStyle(kDashed))
        ...
        ##calculate tau2tau1 cut eff(40-130) SF
        #eff_ttbar_data=self.workspace4fit_.var("eff_ttbar_data_"+self.channel);
        #eff_ttbar_TotalMC=self.workspace4fit_.var("eff_ttbar_TotalMC_"+self.channel);

        #SF_data2MC=eff_ttbar_data.getVal()/eff_ttbar_TotalMC.getVal();
        #SF_data2MC_err= SF_data2MC* TMath.Sqrt(
        #        (eff_ttbar_data.getError()/eff_ttbar_data.getVal())**2+
        #        (eff_ttbar_TotalMC.getError()/eff_ttbar_TotalMC.getVal())**2
        #        ) ;
        #print "data eff=%s +/- %s"%(eff_ttbar_data.getVal(),eff_ttbar_data.getError() );
        #print "MC   eff=%s +/- %s"%(eff_ttbar_TotalMC.getVal(),eff_ttbar_TotalMC.getError() );
        #print "%0.2f +/- %0.f%%"%(SF_data2MC,SF_data2MC_err/SF_data2MC*100 );


        ##calculate tau2tau1 cut  eff
        #self.eventnumber_in_signalregion("_data", model_ttbar_data, rfresult_data);
        #self.eventnumber_in_signalregion("_data_failtau2tau1cut", model_ttbar_data_fail, rfresult_data);
        #self.eventnumber_in_signalregion("_TotalMC", model_ttbar_TotalMC, rfresult_TotalMC);
        #self.eventnumber_in_signalregion("_TotalMC_failtau2tau1cut", model_ttbar_TotalMC_fail, rfresult_TotalMC);

        #rrv_number_data=self.workspace4fit_.var("rrv_number_ttbar_in_mj_signal_region_from_fitting"+"_data"+"_"+self.channel)
        #rrv_number_data_fail=self.workspace4fit_.var("rrv_number_ttbar_in_mj_signal_region_from_fitting"+"_data_failtau2tau1cut"+"_"+self.channel)
        #rrv_number_TotalMC=self.workspace4fit_.var("rrv_number_ttbar_in_mj_signal_region_from_fitting"+"_TotalMC"+"_"+self.channel)
        #rrv_number_TotalMC_fail=self.workspace4fit_.var("rrv_number_ttbar_in_mj_signal_region_from_fitting"+"_TotalMC_failtau2tau1cut"+"_"+self.channel)

        #rrv_number_data.Print();
        #rrv_number_data_fail.Print();
        #rrv_number_TotalMC.Print();
        #rrv_number_TotalMC_fail.Print();

        #SF_data2MC=(rrv_number_data.getVal()/rrv_number_data_fail.getVal()) / (rrv_number_TotalMC.getVal()/rrv_number_TotalMC_fail.getVal());
        #SF_data2MC_err= SF_data2MC* TMath.Sqrt(
        #        (rrv_number_data.getError()/rrv_number_data.getVal())**2+
        #        (rrv_number_data_fail.getError()/rrv_number_data_fail.getVal())**2+
        #        (rrv_number_TotalMC.getError()/rrv_number_TotalMC.getVal())**2+
        #        (rrv_number_TotalMC_fail.getError()/rrv_number_TotalMC_fail.getVal())**2 
        #        ) ;
        #print "data eff=%s"%(rrv_number_data.getVal()/rrv_number_data_fail.getVal() );
        #print "MC   eff=%s"%(rrv_number_TotalMC.getVal()/rrv_number_TotalMC_fail.getVal() );
        #print "%0.2f +/- %0.f%%"%(SF_data2MC,SF_data2MC_err/SF_data2MC*100 );
        ...
        #lowerLimit=0.;
        #upperLimit=1.;
        #ClopperPearsonLimits(rrv_number_data.getVal(), rrv_number_data_fail.getVal(), lowerLimit, upperLimit);
        #print lowerLimit, upperLimit;
        #ClopperPearsonLimits(rrv_number_TotalMC.getVal(), rrv_number_TotalMC_fail.getVal(), lowerLimit, upperLimit);
        #print lowerLimit, upperLimit;
    ...
    def get_mj_and_mlvj_dataset(self,in_file_name, label, jet_mass="jet_mass_pr"):# to get the shape of m_lvj
        ...
        treeIn = fileIn.Get("SelectedCandidatesV2");
        ...
        for i in range(treeIn.GetEntries()):
            ...
            treeIn.GetEntry(i);
            if i==0:
                tmp_scale_to_lumi=treeIn.lumiweight*19770.0;
    
            tmp_jet_mass=getattr(treeIn, "mJJNoKinFit");
            if treeIn.vTagPurity==options.category and  treeIn.mZZ> rrv_mass_lvj.getMin() and treeIn.mZZ<rrv_mass_lvj.getMax() and tmp_jet_mass>50 and tmp_jet_mass<130 :
                #print tmp_jet_mass_dn, tmp_jet_mass, tmp_jet_mass_up;
                tmp_event_weight= treeIn.weight*19770.0;
    ...
    def make_controlplot(self,variable,cut,tag,nbin,min,max,xtitle="",ytitle="",logy=0 ):
        ...
        hist_WJets.SetLineColor(self.color_palet["ZJets"]); hist_WJets.SetFillColor(self.color_palet["ZJets"]);
        ...
        canvas_controlplot = TCanvas("canvas_controlplot"+variable,"canvas_controlplot"+variable, 800,600);
        ...
        Directory=TString("plots_%s_%s_%s/controlplot_wtaggercut%s_nPV%sto%s/"%(options.additioninformation, self.channel, self.PS_model, self.wtagger_label, self.nPV_min, self.nPV_max)+self.signal_sample+"_%02d_%02d/"%(options.cprime,options.BRnew));
    ...
    def fit_mlvj_model_single_MC(self,in_file_name, label, in_range, mlvj_model, deco=0, show_constant_parameter=0, logy=0):# model = shape + normalization
        ...
        if deco :
            ...
            rdataset.plotOn(mplot_deco, RooFit.Name("TTbar MC"));
            model_pdf_deco.plotOn(mplot_deco,RooFit.Name("TTbar"),RooFit.LineColor(kBlack));
            ...
            self.draw_canvas( mplot_deco, "plots_%s_%s_%s/other/"%(options.additioninformation, self.channel,self.PS_model), "m_lvj"+label+in_range+in_range+mlvj_model+"_deco")
        ...
        mplot.GetYaxis().SetRangeUser(1e-2,mplot.GetMaximum()*1.1);
        self.draw_canvas_with_pull( mplot, mplot_pull,parameters_list,"plots_%s_%s_%s/m_lvj_fitting/"%(options.additioninformation, self.channel,self.PS_model), in_file_name,"m_lvj"+in_range+mlvj_model, show_constant_parameter, logy);
    ...
    def fit_WJetsNorm(self): # to  get the normalization of WJets in signal_region
        ...
        #rrv_WJets0massup.Print(); rrv_WJets0massdn.Print();
    ...
    def fit_WJetsNormalization_in_Mj_signal_region(self,label,massscale=""): # to  get the normalization of WJets in signal_region
        ...
        model_data=RooAddPdf("model_data%s_%s_mj"%(massscale,self.channel),"model_data%s_%s_mj"%(massscale,self.channel),RooArgList(model_WJets,model_VV,model_TTbar));
        ...
        if label=="_WJets0":
            ...
            model_data.plotOn(mplot,RooFit.Name("TTbar"), RooFit.Components("model%s_%s_mj,model_TTbar_%s_mj"%(label,self.channel,self.channel)),RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["TTbar"]), RooFit.LineColor(self.color_palet["TTbar"]),RooFit.NormRange("sb_lo,sb_hi"), RooFit.VLines());
            #model_data.plotOn(mplot,RooFit.Name("STop"), RooFit.Components("model%s_%s_mj,model_STop_%s_mj"%(label,self.channel,self.channel)),RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["STop"]), RooFit.LineColor(self.color_palet["STop"]),RooFit.NormRange("sb_lo,sb_hi"), RooFit.VLines());
            model_data.plotOn(mplot,RooFit.Name("WJets"), RooFit.Components("model%s_%s_mj"%(label,self.channel)),RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["ZJets"]), RooFit.LineColor(self.color_palet["ZJets"]),RooFit.NormRange("sb_lo,sb_hi"), RooFit.VLines());
    
            model_data.plotOn(mplot,RooFit.Name("VV_invisible"), RooFit.Components("model%s_%s_mj,model_TTbar_%s_mj,model_VV_%s_mj"%(label,self.channel,self.channel,self.channel)),RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["VV"]), RooFit.LineColor(self.color_palet["VV"]),RooFit.FillStyle(3003),RooFit.Range(rrv_mass_j.getMin(),rrv_mass_j.getMax()),RooFit.NormRange("sb_lo,sb_hi"), RooFit.VLines());
           ...
           # model_data.plotOn(mplot,RooFit.Name("STop_invisible"), RooFit.Components("model%s_%s_mj,model_STop_%s_mj"%(label,self.channel,self.channel)),RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["STop"]), RooFit.LineColor(self.color_palet["STop"]),RooFit.FillStyle(3003),RooFit.Range(rrv_mass_j.getMin(),rrv_mass_j.getMax()),RooFit.NormRange("sb_lo,sb_hi"), RooFit.VLines());
            ...
            model_data.plotOn( mplot,RooFit.Name("_invisible"), RooFit.Components("model%s_%s_mj"%(label,self.channel)), RooFit.LineColor(self.color_palet["ZJets"]), RooFit.Range(rrv_mass_j.getMin(),rrv_mass_j.getMax()),RooFit.LineStyle(kDashed) ,RooFit.NormRange("sb_lo,sb_hi"), RooFit.VLines());
            #model_data.plotOn( mplot,RooFit.Name("_invisible"), RooFit.Components("model%s_%s_mj,model_STop_%s_mj"%(label,self.channel,self.channel)), RooFit.LineColor(self.color_palet["STop"]), RooFit.Range(rrv_mass_j.getMin(),rrv_mass_j.getMax()),RooFit.LineStyle(kDashed) ,RooFit.NormRange("sb_lo,sb_hi"), RooFit.VLines());
            model_data.plotOn( mplot,RooFit.Name("_invisible"), RooFit.Components("model%s_%s_mj,model_TTbar_%s_mj"%(label,self.channel,self.channel)), RooFit.LineColor(self.color_palet["TTbar"]), RooFit.Range(rrv_mass_j.getMin(),rrv_mass_j.getMax()),RooFit.LineStyle(kDashed) ,RooFit.NormRange("sb_lo,sb_hi"), RooFit.VLines());
            model_data.plotOn( mplot,RooFit.Name("_invisible"), RooFit.Components("model%s_%s_mj,model_TTbar_%s_mj,model_VV_%s_mj"%(label,self.channel,self.channel,self.channel)),RooFit.LineColor(self.color_palet["VV"]), RooFit.Range(rrv_mass_j.getMin(),rrv_mass_j.getMax()),RooFit.LineStyle(kDashed) ,RooFit.NormRange("sb_lo,sb_hi"), RooFit.VLines());
            ...
            parameters_list=model_data.getParameters(rdataset_data_mj);
            mplot.GetYaxis().SetRangeUser(1e-2,mplot.GetMaximum()*1.1);
            self.draw_canvas_with_pull( mplot, mplot_pull,parameters_list,"plots_%s_%s_%s/m_j_fitting_wtaggercut%s_nPV%sto%s/"%(options.additioninformation, self.channel,self.PS_model, self.wtagger_label, self.nPV_min, self.nPV_max), "m_j_sideband%s"%(label),"",1)
   ...
   ######## ++++++++++++++
    def fit_mlvj_in_Mj_sideband(self, label, mlvj_region, mlvj_model): 
        ...
        model_data=RooAddPdf("model_data%s%s_mlvj"%(label,mlvj_region),"model_data%s%s_mlvj"%(label,mlvj_region),RooArgList(model_WJets,model_VV_backgrounds, model_TTbar_backgrounds));
        ...
        if label=="_WJets0":
            ...
            model_data.plotOn(mplot, RooFit.Components("model%s_sb_lo_from_fitting_%s_mlvj,model_TTbar_sb_lo_%s_mlvj,model_VV_sb_lo_%s_mlvj"%(label,self.channel,self.channel,self.channel,self.channel)), RooFit.Name("WJets"),RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["ZJets"]), RooFit.LineColor(self.color_palet["ZJets"]), RooFit.VLines()) ;
            model_data.plotOn(mplot, RooFit.Components("model_TTbar_sb_lo_%s_mlvj,model_VV_sb_lo_%s_mlvj"%(self.channel,self.channel,self.channel)), RooFit.Name("TTbar"),RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["TTbar"]), RooFit.LineColor(self.color_palet["TTbar"]), RooFit.VLines());
            ...
            mplot.GetYaxis().SetRangeUser(1e-2,mplot.GetMaximum()*1.1)
            self.draw_canvas_with_pull( mplot, mplot_pull,parameters_list,"plots_%s_%s_%s/m_lvj_fitting/"%(options.additioninformation, self.channel,self.PS_model), "m_lvj_sb_lo%s"%(label),"",1,1)
   ...
   ######## ++++++++++++++
    def fit_mlvj_in_Mj_signalregion(self, label, mlvj_region, mlvj_model):  #mlvj_model="_signal_region"
        ...
        model_data=RooAddPdf("model_data%s%s_mlvj"%(label,mlvj_region),"model_data%s%s_mlvj"%(label,mlvj_region),RooArgList(model_pdf_WJets0_backgrounds, model_pdf_TTbar_backgrounds, model_pdf_VV_backgrounds), RooArgList(number_WJets0_signal_region_mlvj, number_TTbar_signal_region_mlvj, number_VV_signal_region_mlvj) );
...
#            mplot = rrv_mass_lvj.frame(RooFit.Title("M_lvj fitted in M_j sideband "));
#            rdataset_data_mlvj.plotOn( mplot , RooFit.Invisible());
#            model_data.plotOn(mplot, RooFit.Components("model%s_signal_region_from_fitting_%s_mlvj,model_TTbar_signal_region_%s_mlvj,model_STop_signal_region_%s_mlvj,model_VV_signal_region_%s_mlvj"%(label,self.channel,self.channel,self.channel,self.channel)), RooFit.Name("WJets"),RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["ZJets"]), RooFit.LineColor(self.color_palet["ZJets"]), RooFit.VLines()) ;
...
#            parameters_list=model_data.getParameters(rdataset_data_mlvj);
#            mplot.GetYaxis().SetRangeUser(1e-2,mplot.GetMaximum()*1.1)
#            self.draw_canvas_with_pull( mplot, mplot_pull,parameters_list,"plots_%s_%s_%s/m_lvj_fitting/"%(options.additioninformation, self.channel,self.PS_model), "m_lvj_signal_region%s"%(label),"",1,1)
#
#        #model deco
...
#
    ...
    def prepare_limit(self,mode):
        ...
        if self.signal_sample=="ggH600" or self.signal_sample=="ggH700":shape_para_error_alpha=1.4;
    ...
    def read_workspace(self):
        ...
        model_Total_background_MC.plotOn(mplot,RooFit.Normalization(scale_number_Total_background_MC),RooFit.Name("WJets"), RooFit.Components("WJets_%s,VV_%s,TTbar_%s,STop_%s"%(self.channel,self.channel,self.channel,self.channel)),RooFit.DrawOption("F"), RooFit.FillColor(self.color_palet["ZJets"]), RooFit.LineColor(self.color_palet["ZJets"]), RooFit.VLines());
        ...
        if self.signal_sample=="ggH600" or self.signal_sample=="ggH700":
            signal_scale=5;
        else: signal_scale=100;
        model_pdf_signal.plotOn(mplot,RooFit.Normalization(scale_number_signal*signal_scale),RooFit.Name("%s #times %s"%(self.signal_sample, signal_scale)),RooFit.DrawOption("L"), RooFit.LineColor(self.color_palet["Signal"]), RooFit.VLines());
        ...
        self.draw_canvas_with_pull( mplot, mplot_pull,parameters_list,"plots_%s_%s_%s/m_lvj_fitting/"%(options.additioninformation, self.channel,self.PS_model),"check_workspace_for_limit","",0,1);
    ...
    def legend4Plot(self, plot, left=1):
        ...
        for obj in range(int(plot.numItems()) ):
            ...
            #if objName=="WJets": objName = "ZJets"
            print objName;
            if not ( ( (plot.getInvisible(objName)) and (not TString(objName).Contains("Uncertainty")) ) or TString(objName).Contains("invisi") or objName==objName_before  ): 
                ...
                if TString(objName).Contains("Uncertainty") or TString(objName).Contains("sigma"): 
                    ...
                    elif TString(objName).Contains("WJets"): theLeg.AddEntry(theObj, "ZJets","F");
    ...
    def draw_canvas_with_pull(self, mplot, mplot_pull,parameters_list,in_directory, in_file_name, in_model_name="", show_constant_parameter=0, logy=0):# mplot + pull + parameters
        ...
        mplot_pull.GetYaxis().SetRangeUser(-5,5);
        cMassFit = TCanvas("cMassFit","cMassFit", 800,600);
    ...
    def fit_Signal(self):
        ...
        #self.fit_mlvj_model_single_MC(self.file_signal,"_%s"%(self.signal_sample),"_sb_lo","CB_v1");
    ...
    def fit_TTbar_controlsample(self):
        ...
        #self.fit_mj_forPureWJet_TTbar_controlsample(self.file_data,"");
        #self.fit_mj_forPureWJet_TTbar_controlsample(self.file_data,"beforetau2tau1cut_");
