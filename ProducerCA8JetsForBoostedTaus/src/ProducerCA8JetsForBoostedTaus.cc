// -*- C++ -*-
//
// Package:    ProducerCA8JetsForBoostedTaus
// Class:      ProducerCA8JetsForBoostedTaus
// 
/**\class ProducerCA8JetsForBoostedTaus ProducerCA8JetsForBoostedTaus.cc ExoDiBosonResonances/ProducerCA8JetsForBoostedTaus/src/ProducerCA8JetsForBoostedTaus.cc
...
//         Created:  Sun Sep  8 16:34:34 CEST 2013
// $Id$
//
//
...
class ProducerCA8JetsForBoostedTaus : public edm::EDProducer {
   public:
      explicit ProducerCA8JetsForBoostedTaus(const edm::ParameterSet&);
      ~ProducerCA8JetsForBoostedTaus();
...
//
ProducerCA8JetsForBoostedTaus::ProducerCA8JetsForBoostedTaus(const edm::ParameterSet& iConfig):
...
ProducerCA8JetsForBoostedTaus::~ProducerCA8JetsForBoostedTaus()
{
...
void
ProducerCA8JetsForBoostedTaus::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
   ...
   for(unsigned int i = 0; i < Jets->size();++i){
      ...
      //Loops in the subjets and in the daughters of the subjets to fill the vectors above 
      for(unsigned int p=0; p!= jet.numberOfDaughters(); ++p){
         const reco::Candidate* dau = jet.daughter(p);
         const reco::PFJet* subjet = (reco::PFJet*) dau;
         //std::cout << "pT of the SubJet:  " << subjet->pt() << std::endl;
         for(unsigned int pp=0; pp!= subjet->numberOfDaughters(); ++pp){
            const reco::Candidate* subjet_dau = subjet->daughter(pp);           
            //std::cout << "pT of the Daughter of the SubJet:  " << subjet_dau->pt() << std::endl;  
            if(fabs(subjet_dau->charge()) > 0){
               //std::cout << "pT of the Charged Constituents of the SubJet : " << subjet_dau->pt() << std::endl;
               VecPtrJetChargedConstituents.push_back(subjet_dau);
            }else{
               //std::cout << "pT of the Neutral Constituents of the SubJet : " << subjet_dau->pt() << std::endl;
               VecPtrJetNeutralConstituents.push_back(subjet_dau); 
            }
         }  
      }
   ...
   }//end of the for in the Jet collection (not the clone!!!) 
...
void 
ProducerCA8JetsForBoostedTaus::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
ProducerCA8JetsForBoostedTaus::endJob() {
}

// ------------ method called when starting to processes a run  ------------
void 
ProducerCA8JetsForBoostedTaus::beginRun(edm::Run&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
void 
ProducerCA8JetsForBoostedTaus::endRun(edm::Run&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void 
ProducerCA8JetsForBoostedTaus::beginLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
ProducerCA8JetsForBoostedTaus::endLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
ProducerCA8JetsForBoostedTaus::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
bool ProducerCA8JetsForBoostedTaus::sortJetConstituents(const reco::Candidate* cand1, const reco::Candidate* cand2){
  return (cand1->pt() > cand2->pt());
}


//define this as a plug-in
DEFINE_FWK_MODULE(ProducerCA8JetsForBoostedTaus);
