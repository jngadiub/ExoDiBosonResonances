...
cmgWmunuSingleJet = cms.EDFilter(
                   ...
                   cuts = cms.PSet( preSel = cms.PSet( noOverlap  = cms.string(" deltaR(leg1.leg1.eta,leg1.leg1.phi,leg2.eta,leg2.phi) > 0.8 " ),
                                                       ...
                                                       mergedJetID = cms.string("leg2.getSelection(\"cuts_looseJetId\") && leg2.getSelection(\"cuts_TOBTECjetsId\") && leg2.getSelection(\"cuts_looseJetId\") && leg2.getSelection(\"cuts_TOBTECjetsId\")")
                                                       )   
