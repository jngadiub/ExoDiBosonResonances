...
cmgWmunuSingleJet = cms.EDFilter(
                   ...
                   cuts = cms.PSet( preSel = cms.PSet( noOverlap  = cms.string(" deltaR(leg1.leg1.eta,leg1.leg1.phi,leg2.eta,leg2.phi) > 1.0 " ),
                                                                         #   +"deltaR(leg1.leg2.eta,leg1.leg2.phi,leg2.eta,leg2.phi) > 1.0 "),
...
WmunuSingleJetEDBRFactory = cms.PSet(
       ...
       overlapcut = cms.string(" deltaR(vbfptr.leg1.eta,vbfptr.leg1.phi,leg2.eta,leg2.phi) > 1.0 &&"
                               +"deltaR(vbfptr.leg2.eta,vbfptr.leg2.phi,leg2.eta,leg2.phi) > 1.0 &&"
